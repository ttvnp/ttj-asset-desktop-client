      ...
      <v-flex xs12 sm10>
        <v-card>
          ...
          <v-card-text class="desc-privacy-policy">
            ...
            <p>当社では、本プライバシーポリシーを時々修正します。 変更した場合、当社は、本ポリシーの日付を改訂することでお客様に通知します。
            あるいは、状況により、たとえば、SEN POINTプロジェクトサービスのホームページに文言を追加するか、お客様にメール通知やLINE@を送信することで追加事項を連絡します。
            当社の情報ポリシーや、プライバシーに関わるお客様の権利と選択について周知している状態を保つために、SEN POINTプロジェクトサービスにアクセスするたび、またはそれを使用するたびにプライバシーポリシーを見直すことを強くお勧めします。
            </p>
            ...
            <p><b>お客様が当社に提供する情報</b></p>

            <p><b>&nbsp;</b></p>

            <p>当社は、お客様が直接当社に提供する情報を収集します。お客様がオンラインアカウントを作成するとき、取引を完了するとき、フォームに記入するとき、調査に回答するとき、当社のフォーラム等にメッセージを投稿するとき、または別の方法で当社と通信をとるときに、お客様についての情報を収集します。</p>

            <p>&nbsp;</p>

            <p>&nbsp;</p>

            <p><b>収集する可能性のある情報のタイプは次のとおりです。</b></p>
            ...
            <p><b>当社が自動的に収集する情報</b></p>

            <p>&nbsp;</p>

            <p>お客様がSEN POINTプロジェクトサービスにアクセスするか、それを使用するとき、当社は次のように自動的に情報を収集します。</p>
            ...
            <p>当社は、お客様の情報を次のように使用する場合があります。<p>
            ...
            <p>当社は、お客様について当社が収集する任意の情報を、非公開情報やその他の当社が収集する情報を含めて、お客様が現在の顧客であるかかつての顧客であったかにかかわらず、関連会社以外の第三者に開示する場合があります。 </p>

            <p>&nbsp;</p>

            <p style='margin-left:36.0pt;text-indent:-18.0pt'>(1)<span
              style='font:7.0pt "Times New Roman"'>&nbsp; </span>当社に代行してマーケティングサービスを遂行するサービスプロバイダーに対して</p>
            ...
            <p style='margin-left:72.0pt;text-indent:-18.0pt'>・<span
              style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>当社に代行して作業を遂行するためにお客様の情報にアクセスする必要のあるベンダー、コンサルタント、およびその他プロバイダー。これらのサービスプロバイダーは、詐欺防止や技術サービスなどの当社業務を支援します。</p>

            <p style='margin-left:72.0pt;text-indent:-18.0pt'>・<span
              style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>身体的危害または金融損失を防止するため、違法性の疑われる活動を報告するため、あるいは、ユーザー同意事項またはその他のポリシーや同意事項に対する違反を調査する、もしくは、これらを施行するために、お客様の情報の開示が必要であると、当社が独自の裁量で考えた場合。<p>

            <p style='margin-left:72.0pt;text-indent:-18.0pt'>・<span
              style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>合併、SEN POINTプロジェクトの資産の売却、融資、もしくは買収、または、他社に対する当社業務の全部または一部と関連して、あるいはこれらの交渉中に。<p>

            <p style='margin-left:72.0pt;text-indent:-18.0pt'>・<span
              style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>お客様の同意または裁量によって。</p>

            <p>&nbsp;</p>

            <p style='margin-left:36.0pt;text-indent:-18.0pt'>(3)<span
              style='font:7.0pt "Times New Roman"'>&nbsp; </span>当社の法的義務を順守するために、当社がお客様の情報を開示または共有する義務を負う場合。</p>
            ...
            <p><b>他社によって提供される分析サービス</b></p>

            <p>&nbsp;</p>

            <p>当社は、他社が当社に代行して分析サービスを提供することを許容します。 これらの事業体は、クッキー、ウェブビーコン、およびその他の追跡テクノロジーを使用して、お客様のIPアドレス、ウェブブラウザ、表示されたページ、各ページに費やされた時間、およびクリックされたリンクを含めて、SEN POINTプロジェクトサービスのお客様の使用状況についての情報を収集する場合があります。
            この情報は、SEN POINTプロジェクトによって、特に、データを分析、追跡したり、特定のコンテンツの人気度を判定したり、お客様のオンライン活動をより的確に理解するために使用される場合があります。
            <br>
            <br>
            </p>
            ...
            <p>当社では、非公開個人情報を含めてお客様の情報の機密性とセキュリティを保護するために、合理的なセキュリティポリシーを遂行しています。
            当社では、物理面、技術面、管理面での合理的なセキュリティ対策によってお客様の情報を保護しており、たとえばお客様の情報へのアクセスに関わる情報を知る必要のある従業員に制限しています。
            <br>
            <br>
            </p>
            ...
            <p>本プライバシーポリシーに関して疑問点や懸念がある場合には、TTJサイトのContactUS(http://www.ttjworld.com/#/contact-us)にてお問い合わせください。</p>
          </v-card-text>
        </v-card>
      </v-flex>
    </v-layout>
