<template>
  <v-card>
    ...
    <div>
        ...
        <br/>
        <p dir="ltr">
            この規約は、お客様が、株式会社ＴＴＪ（以下「当社」）が提供する「SENPOINTプロジェクト」（以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービス（https://www.ttjworld.comおよびTTJウォレット）をご利用ください。
        </p>
        <br/>
        <p dir="ltr">
        第１条（定義）
        ...
        <p dir="ltr">
        個人情報及び利用者情報については、当社が別途定める「SENPOINTプロジェクトサービスプライバシーポリシー」に則り、適正に取り扱うこととします。
        </p>
        <br/>
        <p dir="ltr">
        第７条（禁止行為）
