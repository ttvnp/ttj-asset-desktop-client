<template>
  <v-card>
    ...
    <div>
        ...
        <br/>
        <p dir="ltr">
            この規約は、お客様が、株式会社ＴＴＪ（以下「当社」）が提供する「SENtokenプロジェクト」（以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービス（https://www.ttjworld.comおよびSENtokenウォレット）をご利用ください。
        </p>
        <br/>
        <p dir="ltr">
            第１条（定義）
        ...
        <p dir="ltr">
            （3）本コンテンツ 本サービス上で提供されるウォレットプログラム、コード、文字、静止画、動画等の総称
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
            （6）メールアドレス 本サービスの利用のために登録利用者が固有に持つ文字列
        </p>
        <p dir="ltr">
            （7）パスワード ＩＤに対応して登録利用者が固有に設定する暗号
        </p>
        <p dir="ltr">
            （8）個人情報 住所、氏名、職業、電話番号、生年月日等個人を特定することのできる情報の総称
        </p>
        <p dir="ltr">
            （9）登録情報 登録利用者が本サイトにて登録した情報の総称
        </p>
        <br/>
        <p dir="ltr">
            第２条（本規約への同意）
        ...
        <p dir="ltr">
            ２　利用者が、本サービスをスマートフォン等その他情報端末にダウンロードし、本規約への同意手続を行った時点で、利用者と当社との間で、本規約の諸規定に従った利用契約が成立するものとします。
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
            １　本サービスへの登録を希望する方（以下「登録希望者」）は、本規約に同意した上で、所定の方法で登録を行ってください。
        </p>
        <p dir="ltr">
            ２　登録をした方は、弊社がその登録を承諾し、ＩＤ登録が完了した時点から登録ユーザとなります。
        </p>
        <p dir="ltr">
            ３　弊社は、登録ユーザ向けにメールで連絡事項の告知や広告その他の情報提供を行います。
        </p>
        <p dir="ltr">
            ４　弊社は、登録希望者が次の各号のいずれか一つに該当する場合は、弊社の判断により登録を承諾しないことがあります。
        </p>
        <p dir="ltr">
            一　登録希望者が、弊社の定める方法によらず登録を行った場合
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
            １　利用者は、利用に際して登録した情報（以下、「登録情報」といいます。メールアドレスやパスワード等を含みます）について、自己の責任の下、任意に登録、管理するものとします。利用者は、これを第三者に利用させ、または貸与、譲渡、名義変更、売買などをしてはならないものとします。
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
            個人情報及び利用者情報については、当社が別途定める「SENtokenプロジェクトサービスプライバシーポリシー」に則り、適正に取り扱うこととします。
        </p>
        <br/>
        <p dir="ltr">
            第７条（禁止行為）　
        ...
        <p dir="ltr">
            本サービスの利用に際し、当社は、利用者に対し、次に掲げる行為を禁止します。当社において、利用者が禁止事項に違反したと認めた場合、利用者用の一時停止、アカウント停止処分その他当社が必要と判断した措置を取ることができます。
        </p>
        <br/>
        <p dir="ltr">
            （１）当社または第三者の名誉・信用を毀損または不当に差別もしくは誹謗中傷する行為
        </p>
        <p dir="ltr">
            （２）当社または第三者の財産を侵害する行為、または侵害する恐れのある行為
        </p>
        <p dir="ltr">
            （３）当社または第三者に経済的損害を与える行為
        </p>
        <p dir="ltr">
            （４）当社または第三者に対する脅迫的な行為
        </p>
        <p dir="ltr">
            （５）コンピューターウィルス、有害なプログラムを仕様またはそれを誘発する行為
        </p>
        <p dir="ltr">
            （６）本サービス用インフラ設備に対して過度な負担となるストレスをかける行為
        </p>
        <p dir="ltr">
            （７）当サイトのサーバーやシステム、セキュリティへの攻撃
        </p>
        <p dir="ltr">
            （８）当社提供のインターフェース以外の方法で当社サービスにアクセスを試みる行為
        </p>
        <p dir="ltr">
            （９）上記の他、当社が不適切と判断する行為
        </p>
        <br/>
        <p dir="ltr">
            第８条（免責）
        ...
        <p dir="ltr">
            ８　第１項から前項までの規定は、当社に故意または重過失が存する場合又は契約書が消費者契約法上の消費者に該当する場合には適用しません。
        </p>
        <p dir="ltr">
