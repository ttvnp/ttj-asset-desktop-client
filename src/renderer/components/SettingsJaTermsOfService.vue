<template>
  <v-card>
    ...
    <div>
        <p dir="ltr">
            SEN POINTプロジェクトサービス<br/>
            利用規約
        </p>
        <br/>
        <p dir="ltr">
            この規約は、お客様が株式会社ＴＴＪ（以下「当社」）が提供する「SEN POINTプロジェクト」
            （以下「本サービス」）をご利用頂く際の取扱いにつき定めるものです。本規約に同意した上で本サービス
            (<a target="_blank" href="http://www.ttjworld.com"><span style='color:#1155CC'>http://www.ttjworld.com</span></a> およびTTJウォレット）をご利用ください。
        </p>
        <br/>
        <p dir="ltr">
        第１条（定義）
        ...
        <p dir="ltr" style='text-indent:16.0pt'>
        ...
        <p dir="ltr">
        個人情報及び利用者情報については、当社が別途定める「SEN POINTプロジェクトサービスプライバシーポリシー」に則り、適正に取り扱うこととします。
        </p>
        <br/>
        <p dir="ltr">
        第７条（禁止行為）
        ...
        <p dir="ltr">
          （2）当社または第三者の財産を侵害する行為、または侵害する恐れのある行為
        </p>
        <p dir="ltr">
          （3）当社または第三者に経済的損害を与える行為
        </p>
        <p dir="ltr">
          （4）当社または第三者に対する脅迫的な行為
        </p>
        <p dir="ltr">
